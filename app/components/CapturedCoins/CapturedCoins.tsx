    ...
    return (
        <div className="pt-2">
            ...
            {capturedPiecesByKind.knight.length > 0 && pieceCoinHash.knight && (
                <CapturedCoinDisplay
                    coinSymbol={pieceCoinHash.knight}
            ...
            {capturedPiecesByKind.bishop.length > 0 && pieceCoinHash.bishop && (
                <CapturedCoinDisplay
                    coinSymbol={pieceCoinHash.bishop}
            ...
            {capturedPiecesByKind.queen.length > 0 && pieceCoinHash.queen && (
                <CapturedCoinDisplay
                    coinSymbol={pieceCoinHash.queen}
